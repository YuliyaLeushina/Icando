(() => {
  ...
  let i = document.querySelectorAll(".input__file");
  Array.prototype.forEach.call(i, function (e) {
    let t = e.nextElementSibling,
      s = t.querySelector(".input__file-button-text").innerText;
    e.addEventListener("change", function (e) {
      let l = "";
      this.files && this.files.length >= 1 && (l = this.files.length),
        (t.querySelector(".input__file-button-text").innerText = l
          ? "Выбрано файлов: " + l
          : s);
    });
  }),
    ...
    (function () {
      ...
      e.length > 0 &&
        (function () {
          ...
          function l(e) {
            c(e), a(), e.classList.contains("rating_set") && i(e);
          }
          function c(e) {
          ...
          async function n(e, t) {
            if (!t.classList.contains("rating_sending")) {
              ...
              if (e.ok) {
                ...
                (s.innerHTML = l), a(), t.classList.remove("rating_sending");
